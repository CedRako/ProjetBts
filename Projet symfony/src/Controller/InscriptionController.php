...
class InscriptionController extends AbstractController
{
    ...
    //Inscription Valider
    #[Route('/formation/inscriptionValider/{id}', name: 'app_inscription_valider')]
   ...
   #[Route('/formation/inscriptionRefuser/{id}', name: 'app_inscription_refuser')]
  ...
  //Afficher les inscriptions de l'employé Connecter 
   #[Route('/formation/afficherInscriptions', name: 'app_affInscriptionId')]
   ...
   //Question 2 pour afficher les inscriptions d'un employé
...
/* QUESTION 3
   #[Route('', name: 'app_Insc')]
   public function afficheDansCarousel(ManagerRegistry $doctrine){
        $session= new Session();
        $inscs=$doctrine->getManager()->getRepository(Inscription::class)->formationPlusDemande();
       ...
       return $this->render('inscription/listeFormInsc.html.twig', array('inscs'=>$inscs, 'message'=>$message));
   }
   */
}
