...
class InscriptionRepository extends ServiceEntityRepository
{
    ...
    //Question 3 , compte le nombre d'inscription
    /*public function formationPlusDemande(): array
    {
        return $this->createQueryBuilder('e')
            ->select('e.id,e.laFormation ,count(e.laformation) as nbrInsc')
            ->setMaxResults(3)
            ->groupBy('e.laFormation')
            ->getQuery()
            ->getResult()
        ;
    }
