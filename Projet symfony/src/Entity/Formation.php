...
class Formation
{
    ...
    public function getNumMinInsc(): ?int
    {
        return $this->numMinInsc;
    }

    public function setNumMinInsc(int $numMinInsc): self
    {
        $this->numMinInsc = $numMinInsc;
